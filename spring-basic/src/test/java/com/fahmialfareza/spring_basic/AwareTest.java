...
import com.fahmialfareza.spring_basic.service.AuthService;
...
public class AwareTest {
    ...
    void testAware() {
        ...
        Assertions.assertEquals("com.fahmialfareza.spring_basic.service.AuthService", authService.getBeanName());
